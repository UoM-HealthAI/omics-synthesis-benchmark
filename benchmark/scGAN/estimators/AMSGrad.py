...
# -*- coding: utf-8 -*-
"""
AMSGrad implementation for TF, taken from : https://github.com/junfengwen/AMSGrad
Based on the ICLR 2018 paper "On the Convergence of Adam and Beyond"
from S.Reddi, S.Kale and S.Kumar
"""
...
class AMSGrad(optimizer.Optimizer):
    def __init__(self, learning_rate=0.01, beta1=0.9, beta2=0.99, epsilon=1e-8,
