...
# Apply CPU patch if running on CPU
import cpu_patch
...
def main():
    ...
    if opt.data_type.lower() == "scanpy":
        ...
        if opt.example_data == 'pbmc':
        ...
        elif opt.example_data == 'tabula_muris':
            print("     -> Reading Tabula Muris")
            # Tabula Muris mouse tissue atlas - 57K cells from 12 tissue types
            train_data_loader, valid_data_loader = Scanpy_IO('/ceph/hpc/home/eujinyuanw/omics_analysis/benchmark/ACTIVA/data/tabula_muris_split.h5ad',
                                                        test_no_valid = True,
                                                        batchSize=opt.batchSize, 
                                                        workers = opt.workers,
                                                        log=False,
            ...
            # Tabula Muris has 12 tissue types: Trachea, Spleen, Tongue, Lung, Limb_Muscle, 
            # Mammary_Gland, Marrow, Kidney, Bladder, Liver, Thymus, Heart_and_Aorta
